...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case SAVE_TRANSACTION:
            return { ...state, actionType: SAVE_TRANSACTION, dataTransaction: action.data, isLoading: true }
        case CLEAR_TRANSACTION:
            return { ...state, actionType: CLEAR_TRANSACTION, dataTransaction: null, isLoading: false }
